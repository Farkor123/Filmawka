...
insert into comments_movies(movie_id, user_id, comment_date,content) values (1, 3, NOW(),'przykadowy komentarz 1');
insert into comments_movies(movie_id, user_id, comment_date,content) values (1, 1, NOW(),'przykadowy komentarz aaaa');
insert into comments_movies(movie_id, user_id, comment_date,content) values (1, 2, NOW(),'przykadowy komentarz bbbb');
insert into comments_movies(movie_id, user_id, comment_date,content) values (1, 3, NOW(),'przykadowy komentarz cccc');
insert into comments_movies(movie_id, user_id, comment_date,content) values (2, 4, NOW(),'przykadowy komentarz dddd');
